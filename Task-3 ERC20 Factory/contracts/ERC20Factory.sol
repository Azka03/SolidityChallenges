...
contract ERC20Factory{
    ...
    function deployToken(string memory _symbol, string memory _name, uint8 deci) public {
    ...
    function setWhiteListed(address addr, bool flag) public {
        require(_onlyWhiteListed[addr] != flag, "This state already exists"); //Mapping will return true/false (true!=false - go ahead)
